...
//		}
	...
	public Map<String, String> uploadPhoto(MultipartFile photo,HttpServletRequest request){
		...
		String savePath = request.getServletContext().getRealPath("/") + "/resources/upload3/";
		...
		ret.put("type", "success");
		ret.put("msg", "图片上传成功！");
		ret.put("filepath",request.getServletContext().getContextPath() + "/resources/upload3/" + filename );
		return ret;
	}
	/**
	 * 判断该用户名是否存在
