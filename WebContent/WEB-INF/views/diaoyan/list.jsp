...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            <label>需求调研报告名称:</label><input id="search-name" class="wu-text" style="width:100px">
...
<div id="add-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:420px; padding:10px;">
	<form id="add-form" method="post">
        <table>
            <tr>
                <td width="60" align="right">需求调研报告名称:</td>
                <td><input type="text" name="name" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写需求调研报告名称'" /></td>
            </tr>
            <tr>
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        ...
        <table>
            <tr>
                <td width="60" align="right">需求调研报告名称:</td>
                <td><input type="text" name="name" id="edit-name" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写需求调研报告名称'" /></td>
            </tr>
            <tr>
                <td width="60" align="right">撰写人:</td>
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'name',title:'需求调研报告名称',width:100},
