...
<div id="add-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:420px; padding:10px;">
	<form id="add-form" method="post">
        <table>
            <tr>
                <td width="60" align="right">年度工作报告名称:</td>
                <td><input type="text" name="name" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写年度工作报告名称'" /></td>
            </tr>
            <tr>
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        ...
        <table>
            <tr>
                <td width="60" align="right">年度工作报告名称:</td>
                <td><input type="text" name="name" id="edit-name" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写年度工作名称'" /></td>
            </tr>
            <tr>
                <td width="60" align="right">撰写人:</td>
...
<script type="text/javascript">
	...
	*/
	$('#data-datagrid').datagrid({
		...
		fit:true,
		columns:[[
			{ field:'name',title:'年度工作报告名称',width:100},
